...
class System(Rest):
    ...
    Workspace ONE UEM REST APIs allows you to manage all the core functionalities
    around console administration where you can:
    ...
    - Group sets of users into user groups which act as filters (in addition to organization groups)
